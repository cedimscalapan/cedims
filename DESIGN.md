...
- **Mark:** the official Calapan East District seal (`static/deped-calapan-east-district.jpg`, `static/deped-official.png`), used on the loader and branding surfaces per `BRANDING_UPDATE.md`. Do not invent a new logo or icon (R-23); the seal is the mark.
