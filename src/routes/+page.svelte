        ...
        <section class="hero">
            ...
            <aside class="document" aria-label="Documents supported by CEDIMS">
                ...
                <dl>
                    ...
                    <div><dt>02 / ISP</dt><dd>Individual School Plan</dd></div>
                    <div><dt>03 / ISR</dt><dd>Individual School Report</dd></div>
                </dl>
...
<style>
    .landing{background:#f7f6f2;color:#233830;font-family:Arial,sans-serif;line-height:1.65}
    header,main,footer{max-width:1160px;margin:auto}
    header{display:flex;align-items:center;justify-content:space-between;padding:24px 28px;border-bottom:1px solid #d9ded5}
    .brand{display:flex;gap:12px;align-items:center;font-weight:750;font-size:20px;letter-spacing:.02em}.brand small{display:block;font-size:11px;font-weight:400;letter-spacing:.03em}.brand img{border-radius:6px}
    ...
    .eyebrow{font-size:11px;font-weight:bold;text-transform:uppercase;letter-spacing:.14em;color:#55675b;margin-bottom:22px}
    h1{font-family:Georgia,serif;font-size:clamp(42px,5vw,66px);font-weight:400;line-height:1.09;letter-spacing:-.04em;margin:0}
    .intro{font-size:18px;line-height:1.8;max-width:470px;margin:26px 0 28px;color:#526256}
    .primary{display:inline-flex;justify-content:space-between;align-items:center;gap:40px;background:#254938;color:#fff;padding:13px 21px;font-size:14px;font-weight:bold;border-radius:3px}.primary:hover{background:#183a2a}.access-note{font-size:12px;color:#5a695f;margin-top:12px}
    .document{background:#fffefb;border:1px solid #d9ded5;padding:30px;box-shadow:7px 7px 0 #e8ebe3}.document-heading{display:flex;align-items:center;gap:18px;font-size:15px;font-weight:bold}.document-heading small{font-size:12px;font-weight:400;color:#526256}.document-heading img{object-fit:contain;border-radius:50%}.document-label{margin-top:32px;font-size:10px;letter-spacing:.1em;text-transform:uppercase;color:#657266}dl{margin-top:12px}dl div{border-top:1px solid #e3e6dd;padding:16px 0;display:flex;gap:16px;align-items:baseline}dt{font-size:11px;min-width:66px;color:#5b6c5e}dd{font-size:14px;font-weight:bold}.document-note{border-top:1px solid #e3e6dd;padding-top:18px;font-size:12px;color:#526256}
    .section{padding:68px 28px;border-top:1px solid #d9ded5;scroll-margin-top:20px}.section-heading{max-width:610px;margin-bottom:36px}h2{font-family:Georgia,serif;font-weight:400;font-size:clamp(30px,3.5vw,42px);line-height:1.15;letter-spacing:-.025em}h3{font-size:17px;font-weight:bold}.section-heading>p:last-child{margin-top:18px;color:#526256}.steps{list-style:none;padding:0;display:grid;grid-template-columns:1fr 1fr;gap:32px 50px}.steps li{display:flex;gap:20px}.number{font-family:Georgia,serif;color:#7a897b;font-size:26px}.steps p,.roles p{font-size:14px;color:#526256;margin-top:9px;line-height:1.85}.tools{margin-top:42px;padding:24px 0;border-top:1px solid #d9ded5;display:grid;grid-template-columns:1fr 2fr;gap:32px}.tools p{font-size:14px;color:#526256}
    .roles{display:grid;grid-template-columns:1fr 1fr;gap:0 50px}.roles article{border-top:1px solid #cbd4c7;padding:26px 0}.role-title{display:flex;align-items:center;justify-content:space-between;gap:12px}.role-title span{font-size:10px;border:1px solid #ccd5c7;border-radius:3px;padding:3px 7px;white-space:nowrap}.roles .scope{font-size:12px;color:#254938;font-weight:bold}
    .schools{list-style:none;padding:0;display:grid;grid-template-columns:repeat(5,1fr);gap:20px}.schools li{text-align:center}.schools img{object-fit:contain;margin:0 auto 20px;border-radius:50%;background:#fff}.schools h3{font-size:15px}.schools small{display:block;font-size:11px;font-weight:400;color:#526256}
    .commitment{margin:0 28px;padding:38px;background:#eeeae1;display:grid;grid-template-columns:160px 1fr;gap:42px;align-items:start}.commitment img{width:100%;height:auto}.commitment p:not(.eyebrow){font-size:14px;line-height:1.85;margin-top:16px;color:#526256}.commitment h2{font-size:32px}
    .entry{padding:65px 28px;display:flex;align-items:center;justify-content:space-between;gap:32px}.entry h2{font-size:30px}.entry p{font-size:13px;max-width:600px;color:#526256;margin-top:12px}.entry .primary{flex-shrink:0}footer{border-top:1px solid #d9ded5;padding:28px 28px 85px;display:flex;justify-content:space-between;gap:20px;font-size:12px}footer p{color:#526256;margin-top:8px}.footer-links{display:flex;gap:24px;align-items:start}
    @media(max-width:760px){header{flex-wrap:wrap;padding:18px 22px}.menu-toggle{display:block;border:1px solid #b7c2b1;padding:7px 12px;border-radius:3px;font-size:13px}nav{display:none;width:100%;padding-top:20px;flex-wrap:wrap;gap:18px}nav.open{display:flex}.hero{grid-template-columns:1fr;gap:35px;padding:48px 22px}.document{max-width:480px;padding:24px}.section{padding:44px 22px}.steps,.roles{grid-template-columns:1fr;gap:24px}.roles{gap:0}.tools{grid-template-columns:1fr;gap:14px}.schools{grid-template-columns:repeat(2,1fr);gap:28px}.schools li:last-child{grid-column:1/-1}.commitment{margin:0 22px;padding:25px;grid-template-columns:1fr;gap:22px}.commitment img{width:110px}.entry{padding:44px 22px;align-items:start;flex-direction:column}footer{padding:24px 22px 90px;flex-direction:column}.footer-links{margin-top:10px}}
</style>
