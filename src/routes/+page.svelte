...
<style>
    .landing{--brand-navy:#123b63;--brand-blue:#1e40af;--brand-gold:#f2b705;--brand-red:#ce1126;--brand-ink:#172b3f;--brand-muted:#536779;--brand-line:#d9e1e8;background:#f5f7fa;color:var(--brand-ink);font-family:"Segoe UI",Roboto,system-ui,sans-serif;line-height:1.65}
