...
TRAINING_DATA = [
    ...
    {"text": "Can you generate a report?", "intent": "create_report"},
    {"text": "I need a compliance report", "intent": "create_report"},
    {"text": "Give me a report of all submissions", "intent": "create_report"},
    {"text": "Create an Excel report for my district", "intent": "create_report"},
    {"text": "Generate a Word report", "intent": "create_report"},
    {"text": "Can I get a report in Excel?", "intent": "create_report"},
    {"text": "Can you export a report for me?", "intent": "create_report"},
    {"text": "Build a compliance report for this school year", "intent": "create_report"},
    {"text": "I want to download a compliance report", "intent": "create_report"},
    {"text": "Generate a report of teacher submissions", "intent": "create_report"},
    {"text": "Prepare a report for my district", "intent": "create_report"},
    {"text": "Can you make a report of compliance status?", "intent": "create_report"},
    {"text": "Create a submission report", "intent": "create_report"},
    {"text": "Generate a report I can export", "intent": "create_report"},
    {"text": "Give me a downloadable compliance report", "intent": "create_report"},
    {"text": "Can you generate an Excel file for compliance?", "intent": "create_report"},
    {"text": "I need a Word document of the compliance report", "intent": "create_report"},
    {"text": "Please create a report for the district", "intent": "create_report"},
    {"text": "Generate my school's compliance report", "intent": "create_report"},
    {"text": "Make a report of who is compliant", "intent": "create_report"},
    {"text": "Export a compliance report to Excel", "intent": "create_report"},
    {"text": "Export a compliance report to Word", "intent": "create_report"},
    {"text": "Can I export a report of all teachers?", "intent": "create_report"},
    {"text": "Generate the district compliance report", "intent": "create_report"},
    {"text": "Generate the school compliance report", "intent": "create_report"},
    {"text": "Create a report I can send to my supervisor", "intent": "create_report"},
    {"text": "I need a printable compliance report", "intent": "create_report"},
    {"text": "Can you build me a report with all the numbers?", "intent": "create_report"},
    {"text": "Create a report of late and missing submissions", "intent": "create_report"},
    {"text": "Give me a full compliance report", "intent": "create_report"},
    {"text": "Generate a report for this term", "intent": "create_report"},
    {"text": "Make me an official compliance report", "intent": "create_report"},
    {"text": "Can you prepare a report document?", "intent": "create_report"},
    {"text": "I want a report of all schools in the district", "intent": "create_report"},
    {"text": "Create a report summary for submissions", "intent": "create_report"},
    {"text": "Generate a report file", "intent": "create_report"},
    {"text": "Download a compliance report now", "intent": "create_report"},
    {"text": "Please generate a report", "intent": "create_report"},
    {"text": "Can I have a compliance report as a Word file?", "intent": "create_report"},
    {"text": "Can I have a compliance report as an Excel file?", "intent": "create_report"},
    {"text": "Create a report with teacher names and status", "intent": "create_report"},
    {"text": "I'd like an exportable report", "intent": "create_report"},
    # Typo variants
    {"text": "Genarate a compliance report", "intent": "create_report"},
    {"text": "Creat a report for my skool", "intent": "create_report"},
    {"text": "Make me a complience report", "intent": "create_report"},
    {"text": "Can you genarate a report?", "intent": "create_report"},
    {"text": "I need a complience report", "intent": "create_report"},
    {"text": "Give me a report of all sumissions", "intent": "create_report"},
    {"text": "Creat an Excel report for my distric", "intent": "create_report"},
    {"text": "Can I get a report in excell?", "intent": "create_report"},
    {"text": "Can you export a report four me?", "intent": "create_report"},
    {"text": "Bild a compliance report for this school yeer", "intent": "create_report"},
    {"text": "I want to download a complience report", "intent": "create_report"},
    {"text": "Genarate a report of teacher sumissions", "intent": "create_report"},
    {"text": "Prepair a report for my distric", "intent": "create_report"},
    {"text": "Creat a sumission report", "intent": "create_report"},
    {"text": "Export a complience report to excell", "intent": "create_report"},
    {"text": "Genarate the distric compliance report", "intent": "create_report"},
    # Tagalog variants
    {"text": "Gumawa ng compliance report", "intent": "create_report"},
    {"text": "Gumawa ng report para sa paaralan ko", "intent": "create_report"},
    {"text": "Gawan mo ako ng compliance report", "intent": "create_report"},
    {"text": "Puwede bang gumawa ka ng report?", "intent": "create_report"},
    {"text": "Kailangan ko ng compliance report", "intent": "create_report"},
    {"text": "Bigyan mo ako ng report ng lahat ng submissions", "intent": "create_report"},
    {"text": "Gumawa ng Excel report para sa distrito ko", "intent": "create_report"},
    {"text": "Gumawa ng Word report", "intent": "create_report"},
    {"text": "Puwede bang makakuha ng report sa Excel?", "intent": "create_report"},
    {"text": "Puwede mo bang i-export ang report para sa akin?", "intent": "create_report"},
    {"text": "Gumawa ng compliance report para ngayong school year", "intent": "create_report"},
    {"text": "Gusto kong i-download ang compliance report", "intent": "create_report"},
    {"text": "Gumawa ng report ng mga submission ng guro", "intent": "create_report"},
    {"text": "Ihanda ang report para sa distrito ko", "intent": "create_report"},
    {"text": "Puwede bang gumawa ng report ng compliance status?", "intent": "create_report"},
    {"text": "Gumawa ng submission report", "intent": "create_report"},
    {"text": "Gumawa ng report na puwede kong i-export", "intent": "create_report"},
    {"text": "Bigyan mo ako ng compliance report na puwedeng i-download", "intent": "create_report"},
    {"text": "Puwede bang gumawa ng Excel file para sa compliance?", "intent": "create_report"},
    {"text": "Kailangan ko ng Word document ng compliance report", "intent": "create_report"},
    {"text": "Gumawa ng report para sa distrito", "intent": "create_report"},
    {"text": "Gumawa ng compliance report ng paaralan ko", "intent": "create_report"},
    {"text": "Gumawa ng report kung sino ang compliant", "intent": "create_report"},
    {"text": "I-export ang compliance report sa Excel", "intent": "create_report"},
    {"text": "I-export ang compliance report sa Word", "intent": "create_report"},
    {"text": "Puwede bang i-export ang report ng lahat ng guro?", "intent": "create_report"},
    {"text": "Gumawa ng district compliance report", "intent": "create_report"},
    {"text": "Gumawa ng school compliance report", "intent": "create_report"},
    {"text": "Gumawa ng report na puwede kong ipadala sa supervisor ko", "intent": "create_report"},
    {"text": "Kailangan ko ng compliance report na puwedeng i-print", "intent": "create_report"},
    {"text": "Puwede bang gawan mo ako ng report na may lahat ng numero?", "intent": "create_report"},
    {"text": "Gumawa ng report ng mga late at missing submissions", "intent": "create_report"},
    {"text": "Bigyan mo ako ng kumpletong compliance report", "intent": "create_report"},
    {"text": "Gumawa ng report para sa term na ito", "intent": "create_report"},
...
SLOT_TEMPLATES = {
    ...
    "create_report": {
        "en": [
            ...
            "Export a compliance report for {school}",
            "Create a report of compliance {term}",
        ],
        "tl": [
            ...
            "I-export ang compliance report para sa {school}",
            "Gumawa ng report ng compliance {term}",
        ],
    },
}
